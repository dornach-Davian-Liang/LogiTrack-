...
Write-Host "[1/6] 移动快速开始文档..." -ForegroundColor Yellow
...
Write-Host "[2/6] 移动部署文档..." -ForegroundColor Yellow
...
Write-Host "[3/6] 移动功能设计文档..." -ForegroundColor Yellow
...
Write-Host "[4/6] 移动测试文档..." -ForegroundColor Yellow
...
Write-Host "[5/6] 移动Bug修复文档..." -ForegroundColor Yellow
...
Write-Host "[6/6] 移动实现报告文档..." -ForegroundColor Yellow
...
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "文档已整理到以下目录：" -ForegroundColor White
Write-Host "  docs/01-getting-started/    - 快速开始" -ForegroundColor Gray
Write-Host "  docs/02-deployment/         - 部署指南" -ForegroundColor Gray
Write-Host "  docs/03-features/           - 功能设计" -ForegroundColor Gray
Write-Host "  docs/04-testing/            - 测试文档" -ForegroundColor Gray
Write-Host "  docs/05-bugfixes/           - Bug修复" -ForegroundColor Gray
Write-Host "  docs/06-implementation-reports/ - 实现报告" -ForegroundColor Gray
Write-Host ""
